...
describe('the resting launcher anchor', () => {
  it('pins two edges, never four', () => {
    // A fixed box with top AND bottom set takes its height from those offsets, and useDragSnap feeds
    // the measured height back into top — derived from window.innerHeight, which is not what the
    // browser resolves top against. The two disagreed by 70px on app.marketrix.co and the launcher
    // climbed out of the viewport a step per measurement.
