  ...
  return (
    <div className="fixed top-4 left-4 z-50 bg-green-500 text-white p-3 rounded-lg shadow-lg max-w-sm">
      ...
      <div className="text-sm space-y-1">
        <div><strong>Header:</strong> {settings.widget_header}</div>
        <div><strong>Position:</strong> {settings.widget_position}</div>
        <div><strong>Appearance:</strong> {settings.widget_appearance}</div>
