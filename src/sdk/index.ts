 ...
 * `configureSdk` points it at an api host and `sdk` proxies the current client, plus the schemas and types
...
export { WidgetCommandSchema, WidgetEventSchema, WidgetSettingsDataSchema } from './contracts/widget';
export type {
  ApplicationWidgetPublicData,
  InstructionType,
  WidgetCommand,
  WidgetEvent,
  WidgetSettingsData,
} from './contracts/widget';
