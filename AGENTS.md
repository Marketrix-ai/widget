...
The widget is the runtime component of what users call **Widgets** in the dashboard. It connects to an **Application** and an **Agent**. See root `AGENTS.md` glossary for full terminology.
